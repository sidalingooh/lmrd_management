...
<form id="form1" class="layui-form" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="agentName" id="agentName" lay-verify="title" autocomplete="off" placeholder="请输入公司名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="legalPersonName" id="legalPersonName" lay-verify="title" autocomplete="off" placeholder="请输入法人姓名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">法人电话</label>
        <div class="layui-input-inline">
            <input type="text" name="legalPersonPhone" id="legalPersonPhone" lay-verify="title" autocomplete="off" placeholder="请输入法人电话" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="legalPersonIdcard" id="legalPersonIdcard" lay-verify="title" autocomplete="off" placeholder="请输入法人证件号码" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">联系人姓名</label>
        <div class="layui-input-inline">
            <input type="text" name="contactName" id="contactName" lay-verify="title" autocomplete="off" placeholder="请输入联系人姓名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">联系人电话</label>
        <div class="layui-input-inline">
            <input type="text" name="contactPhone" id="contactPhone" lay-verify="title" autocomplete="off" placeholder="请输入联系人电话" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">联系人邮箱</label>
        <div class="layui-input-inline">
            <input type="text" name="email" id="email" lay-verify="title" autocomplete="off" placeholder="请输入联系人邮箱" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="bizLicenseNo" id="bizLicenseNo" lay-verify="title" autocomplete="off" placeholder="请输入统一社会信用代码/注册号/组织机构代码" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    getAllProvince();
    getAllIndustryClassificationLeve1();
</script>
</html>